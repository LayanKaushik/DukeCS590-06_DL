...
import hw4_deepQ_utils as utils
import deep_q_network as deep_q
...
class DDQNAgent(object):
    def __init__(self, gamma, epsilon, lr, n_actions, input_dims,
        ...
        self.memory = utils.ReplayBuffer(mem_size, input_dims, n_actions)

        self.q_eval = deep_q.DeepQNetwork(self.lr, self.n_actions,
                                    input_dims=self.input_dims,
                                    name=self.env_name+'_'+self.algo+'_q_eval',
                                    chkpt_dir=self.chkpt_dir)
        self.q_next = deep_q.DeepQNetwork(self.lr, self.n_actions,
                                    input_dims=self.input_dims,
